...
The Python Interface uses several parameters. The periodogram generated by the algorithm is normalized, and there is no option to use different normalizations. 
